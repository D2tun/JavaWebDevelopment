...
public class CommandManager {
	...
	private CommandManager() {
		this.commands.put(rb.getString("exitCommandRequest"), 
						  new ExitCommand());
		this.commands.put(rb.getString("showDerivativeTotalCost"),
						  new CountCostCommand());
		this.commands.put(rb.getString("sortByRisk"), new SortByRiskCommand());
		this.commands.put(rb.getString("findCommitments"), 
						  new SearchCommitmentsCommand());
	}
