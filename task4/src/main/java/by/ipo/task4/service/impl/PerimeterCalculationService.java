...
/**
 * This class represents service of triangle's perimeter calculation.
 * @author Pavel Isidovich
 *
 */
public class PerimeterCalculationService implements FigureService {
	
	private static org.apache.logging.log4j
					.Logger logger = LogManager.getFormatterLogger();
	
	private static PerimeterCalculationService instance = 
						new PerimeterCalculationService();
	
	public static PerimeterCalculationService getInstance() {
		return instance;
	}
	 ...
	 * suffix, returns triangle's perimeter.
