 ...
 * triangle's first point's x-coordinate.
 * @author Pavel Isidovich
 * @see Triangle
 */
public class FirstXComparator implements Comparator<Triangle> {
	...
	public int compare(Triangle o1, Triangle o2) {
		return Double.compare(o1.getPoint(0).getX(), o2.getPoint(0).getX());
	}
