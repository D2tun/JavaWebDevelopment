...
/**
 * This class represents command to multiply matrix by number.
...
public class MatrixMultiplyCommand implements Command {
	...
	*/
	...
	public void run() {
		...
		MatrixOperationService mos = sf.getMatrixMultiplyService();

		String[] paths = mw.dataRequest(rb.getString("pathRequest3"))
															.split(",");
