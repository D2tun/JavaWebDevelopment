...
public class CommandManager {
	...
	private CommandManager() {
		...
		this.commands.put(rb.getString("matrixTranspositionCommandRequest"), 
						  new MatrixTranspositionCommand());
		this.commands.put(rb.getString("matrixMultiplyCommandRequest"), 
						  new MatrixMultiplyCommand());
	}
